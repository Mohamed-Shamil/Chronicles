  ...
  return (
    <div className="flex h-screen overflow-y-scroll">
      <div className="mt-20 ml-28">
        ...
        {about ? (
          <div>
            <div className="border p-3 border-gray-300 mb-5">

            <h1 className="text-2xl mb-2 text-gray-600 font-semibold ">Bio</h1>
            <p className="text-md font-medium text-gray-500">{bio? bio:"Share a glimpse of who you are ..."}</p>
            </div>
