...
export default function Content() {
  ...
  {obj.subTitle ? (
    <h2 className="text-lg hover:underline font-extralight font-serif mb-2">
      {obj.subTitle.split(' ').slice(0, 12).join(' ')} {/* Limit to 5 words */}
      {obj.subTitle.split(' ').length > 5 ? '...' : ''}
    </h2>
  ) : null}
  <div
  ...
  ></div>
              ...
              {obj.imageUrl && (
                ...
                className="w-1/3  h-52  object-cover p-3 object-center"
                src={obj.imageUrl}
                alt="Post Image"
                />
              )}
